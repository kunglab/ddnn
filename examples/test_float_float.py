...
from elaas.family.float_float import FloatFloatFamily
...
mnist = Collection('float_float_cifar10', args.save_dir, input_dims=3, nepochs=args.epochs, verbose=args.verbose)
mnist.set_model_family(FloatFloatFamily)
