...
mnist = Collection('binary_multiinput_increasing_mpcc_{}'.format(reduce(lambda x,y: str(x)+str(y), args.ncams)), args.save_dir, input_dims=3, nepochs=args.epochs, verbose=args.verbose)
