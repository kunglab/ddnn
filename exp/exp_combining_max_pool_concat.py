...
mnist = Collection('multiinput_edge_mpcc_{}'.format(args.ncams), args.save_dir, input_dims=3, nepochs=args.epochs, verbose=args.verbose)

ncams = args.ncams
mnist.set_model_family(MultiInputEdgeFamily,ninputs=ncams,batchsize=400,merge_function="max_pool_concat")
