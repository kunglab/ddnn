...
from elaas.family.single_input import SingleInputFamily
...
parser.add_argument('-n', '--ncams', type=str,  default="5")
args = parser.parse_args()

args.ncams = [int(i) for i in args.ncams.split(",")]
suffix = "_".join([str(i) for i in args.ncams])
mnist = Collection('binary_multiinput_individual_single_cccc_1_{}'.format(suffix), args.save_dir, input_dims=3, nepochs=args.epochs, verbose=args.verbose)

ncams = args.ncams
mnist.set_model_family(SingleInputFamily,batchsize=700)
